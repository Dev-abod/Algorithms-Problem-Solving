...
short CalculatelVacationDays(stDate DateFrom, stDate DateTo)
{
    short DaysCount = 0;

    while (IsDat1BeforDate2(DateFrom, DateTo))
    {
...
void PrintResult()
{
    ...
    cout << "\tVacation To   : ";
    cout << DayShortName(DayOfWeekOrder(DateTo)) << " , ";
    cout << DateTo.Day << "/" << DateTo.Month << "/" << DateTo.Year << endl;

    cout << "\n\tActucal Vacation Days is: " << CalculatelVacationDays(DateFrom, DateTo) << endl;
}
