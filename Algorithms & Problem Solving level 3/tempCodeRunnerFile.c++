...
void ShowMainMenue();
void PerfromTransactionsOptions(enTransactionOptions TransactionsOptions);
...
void ShowTransactions()
{
    ...
    cout << "=======================================\n";
    PerfromTransactionsOptions((enTransactionOptions)ReadTransactionsOption());
}
...
void ShowDeposit()
{
    ...
    if (FindClientByAccountNumber(AccountNumber, vClients, Client))
    {
        ...
        cin >> perfromTransaction;
        if (perfromTransaction)
        {
            for (sClient &C : vClients)
            {
